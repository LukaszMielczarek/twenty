...
import {getCategories, getManufacturers, getProducts} from "@/activities/quotation/api/quotations";
  ...
  useEffect(() => {
    if (manufacturers && manufacturers.length > 0 && categories && categories.length > 0) {
      setColumns([
        ...
        {
          field: 'categoryId', headerName: "CATEGORY", editable: true,
          type: 'singleSelect',
          getOptionValue: (value: any) => {
            return value.id;
          },
        ...
        {
          field: 'productId', headerName: "PRODUCT NAME", editable: true,
          type: 'singleSelect',
          getOptionValue: (value: any) => {
            return value.id;
          },
        ...
        {field: 'netPrice', headerName: "NET PRICE", editable: false},
        {
          field: 'grossPrice',
        ...
        {field: 'vatAmount', headerName: "VAT AMOUNT", editable: false},
